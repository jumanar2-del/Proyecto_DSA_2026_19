...
"---\n\n"
"## Pregunta de negocio\n"
"> *¿Qué productos se le deberían recomendar a cada cliente según su historial de compra "
"y sus características comerciales, con el fin de aumentar la probabilidad de compra y "
"la activación del portafolio?*\n\n"
...
"Se construye un grid completo de todas las combinaciones (mes, cliente, producto) "
"y se calculan features basadas en el historial de compra:\n\n"
"| Feature | Descripción |\n"
"|---|---|\n"
...
"El **último mes (202605)** se reserva como test. Los meses anteriores (202602–202604) "
"se usan para entrenamiento. Este enfoque replica el uso real del modelo: "
"entrenamos con lo pasado y predecimos el futuro."
))
cells.append(code(
"FEATURES = [\n"
...
"Se entrenan tres modelos de complejidad creciente. Todos los experimentos "
"quedan registrados en MLflow (parámetros, métricas y modelos serializados).\n\n"
"| Modelo | Tipo |\n"
"|---|---|\n"
...
# ── 5. Evaluación ───────────────────────────────────────────
cells.append(md("## 5. Evaluación y selección del mejor modelo"))
cells.append(code(
...
"1. **El historial domina las predicciones**: `freq_compra` (57%) y `veces_comprado` (30%) "
"concentran ~87% de la importancia. El comportamiento pasado es el mejor predictor de compra futura.\n\n"
"2. **Segmentación comercial aporta valor incremental**: `seg5_enc` y `seg4_enc` aportan ~3%, "
"confirmando que clientes del mismo segmento tienen patrones similares.\n\n"
"3. **La regresión logística sirve como baseline**: ROC-AUC = 0.80, notablemente inferior, "
"lo que confirma que la relación entre features y compra es no-lineal.\n\n"
"4. **Gradient Boosting vs Random Forest**: ambos tienen AUC similar (~0.91), pero Gradient "
"Boosting tiene mayor precisión (0.72 vs 0.53), lo que reduce las recomendaciones incorrectas "
"— comportamiento preferible en producción.\n\n"
"5. **El desbalance de clases está manejado**: con ~21% de positivos y `class_weight='balanced'`, "
"los modelos no colapsan prediciendo siempre la clase mayoritaria."
))

# ── 6. Recomendaciones ──────────────────────────────────────
cells.append(md(
"## 6. Generación de recomendaciones Top-3\n\n"
"Con el mejor modelo entrenado, se predicen las probabilidades de compra para cada par "
"(cliente, producto) usando el último mes como contexto. Se excluyen los productos que "
"el cliente ya compró ese mes y se entregan los 3 con mayor probabilidad."
))
cells.append(code(
...
# ── 7. Guardar ──────────────────────────────────────────────
cells.append(md("## 7. Guardar resultados"))
cells.append(code(
...
with open("02_modelo_recomendacion.ipynb", "w", encoding="utf-8") as f:
    json.dump(nb, f, ensure_ascii=False, indent=1)

print("Notebook creado: 02_modelo_recomendacion.ipynb")
